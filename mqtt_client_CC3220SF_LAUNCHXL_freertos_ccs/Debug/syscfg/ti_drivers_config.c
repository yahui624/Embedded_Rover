...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    /* SLAVE_SELECT1 */
    GPIOCC32XX_GPIO_00 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH,
    /* SLAVE_SELECT3 */
    GPIOCC32XX_GPIO_17 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH,
    /* SLAVE_SELECT2 */
    GPIOCC32XX_GPIO_28 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH,
};
...
const uint_least8_t SLAVE_SELECT1_CONST = SLAVE_SELECT1;
const uint_least8_t SLAVE_SELECT3_CONST = SLAVE_SELECT3;
const uint_least8_t SLAVE_SELECT2_CONST = SLAVE_SELECT2;
...
const PWM_Config PWM_config[CONFIG_PWM_COUNT] = {
    /* CONFIG_PWM_GRIPPER */
    {
        ...
        .object = &pwmTimerCC32XXObjects[CONFIG_PWM_GRIPPER],
        .hwAttrs = &pwmTimerCC32XXHWAttrs[CONFIG_PWM_GRIPPER]
    },
};

const uint_least8_t CONFIG_PWM_GRIPPER_CONST = CONFIG_PWM_GRIPPER;
...
const Timer_Config Timer_config[CONFIG_TIMER_COUNT] = {
    /* CONFIG_TIMER_IR */
    {
        ...
        .object      = &timerCC32XXObjects[CONFIG_TIMER_IR],
        .hwAttrs     = &timerCC32XXHWAttrs[CONFIG_TIMER_IR]
    },
    /* CONFIG_TIMER_STATISTICS */
    {
        .fxnTablePtr = &TimerCC32XX_fxnTable,
        .object      = &timerCC32XXObjects[CONFIG_TIMER_STATISTICS],
        .hwAttrs     = &timerCC32XXHWAttrs[CONFIG_TIMER_STATISTICS]
    },
    /* CONFIG_TIMER_ENCODERS */
    {
        .fxnTablePtr = &TimerCC32XX_fxnTable,
        .object      = &timerCC32XXObjects[CONFIG_TIMER_ENCODERS],
        .hwAttrs     = &timerCC32XXHWAttrs[CONFIG_TIMER_ENCODERS]
    },
    /* CONFIG_TIMER_MOVEMENT */
    {
        .fxnTablePtr = &TimerCC32XX_fxnTable,
        .object      = &timerCC32XXObjects[CONFIG_TIMER_MOVEMENT],
        .hwAttrs     = &timerCC32XXHWAttrs[CONFIG_TIMER_MOVEMENT]
    },
};

const uint_least8_t CONFIG_TIMER_IR_CONST = CONFIG_TIMER_IR;
const uint_least8_t CONFIG_TIMER_STATISTICS_CONST = CONFIG_TIMER_STATISTICS;
const uint_least8_t CONFIG_TIMER_ENCODERS_CONST = CONFIG_TIMER_ENCODERS;
const uint_least8_t CONFIG_TIMER_MOVEMENT_CONST = CONFIG_TIMER_MOVEMENT;
...
const uint_least8_t CONFIG_UART_MOTOR_CONST = CONFIG_UART_MOTOR;
